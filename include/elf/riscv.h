...
START_RELOC_NUMBERS (elf_riscv_reloc_type)
  ...
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_SWGP, 252)
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_SDGP, 253)
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_LWGP, 254)
  RELOC_NUMBER (R_RISCV_GPREL_ZCE_LDGP, 255)
