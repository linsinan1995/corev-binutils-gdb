...
{"zext.b",      0, INSN_CLASS_ZCEE, "CZc,Cw",  MATCH_C_ZEXT_B, MASK_C_ZEXT_B, match_opcode, INSN_ALIAS },
{"zext.b",      0, INSN_CLASS_I, "d,s",       MATCH_ANDI|ENCODE_ITYPE_IMM (255), MASK_ANDI | MASK_IMM, match_opcode, INSN_ALIAS },
{"andi",        0, INSN_CLASS_ZCEE, "CZc,Cw,nf",  MATCH_C_ZEXT_B, MASK_C_ZEXT_B, match_opcode, INSN_ALIAS },
...
{"lb",          0, INSN_CLASS_ZCEB, "Ct,CZb(Cs)", MATCH_C_LB, MASK_C_LB, match_opcode, INSN_ALIAS|INSN_DREF|INSN_1_BYTE },
...
{"lbu",         0, INSN_CLASS_ZCEB, "Ct,CZb(Cs)", MATCH_C_LBU, MASK_C_LBU, match_opcode, INSN_ALIAS|INSN_DREF|INSN_1_BYTE },
...
{"lh",          0, INSN_CLASS_ZCEB, "Ct,CZh(Cs)", MATCH_C_LH, MASK_C_LH, match_opcode, INSN_ALIAS|INSN_DREF|INSN_2_BYTE },
...
{"lhu",         0, INSN_CLASS_ZCEB, "Ct,CZh(Cs)", MATCH_C_LHU, MASK_C_LHU, match_opcode, INSN_ALIAS|INSN_DREF|INSN_2_BYTE },
...
{"sb",          0, INSN_CLASS_ZCEB, "Ct,CZb(Cs)", MATCH_C_SB, MASK_C_SB, match_opcode, INSN_DREF|INSN_1_BYTE|INSN_ALIAS },
...
{"sh",          0, INSN_CLASS_ZCEB, "Ct,CZh(Cs)", MATCH_C_SH, MASK_C_SH, match_opcode, INSN_DREF|INSN_2_BYTE|INSN_ALIAS },
...
{"sext.w",     64, INSN_CLASS_ZCEE, "nd,CU",  MATCH_C_ADDIW, MASK_C_ADDIW|MASK_RVC_IMM, match_opcode, INSN_ALIAS },
...
{"mul",        0, INSN_CLASS_ZCEE,  "CZc,Cw,Ct",  MATCH_C_MUL, MASK_C_MUL, match_opcode, INSN_ALIAS },
...
/* ZCEE subset, where ZCEE is a subset of ZCE  */
{"c.sext.b",  0,  INSN_CLASS_ZCEE,  "CZc",  MATCH_C_SEXT_B, MASK_C_SEXT_B, match_opcode, 0 },
{"c.sext.h",  0,  INSN_CLASS_ZCEE,  "CZc",  MATCH_C_SEXT_H, MASK_C_SEXT_H, match_opcode, 0 },
{"c.zext.b",  0,  INSN_CLASS_ZCEE,  "CZc",  MATCH_C_ZEXT_B, MASK_C_ZEXT_B, match_opcode, 0 },
{"c.zext.h",  0,  INSN_CLASS_ZCEE,  "CZc",  MATCH_C_ZEXT_H, MASK_C_ZEXT_H, match_opcode, 0 },
{"c.sext.w",  64, INSN_CLASS_ZCEE,  "nd",   MATCH_C_ADDIW, MASK_C_ADDIW|MASK_RVC_IMM, match_opcode, INSN_ALIAS },
{"c.zext.w",  64, INSN_CLASS_ZCEE,  "CZc",  MATCH_C_ZEXT_W, MASK_C_ZEXT_W, match_opcode, 0 },
{"c.mul",     0,  INSN_CLASS_ZCEE,  "CZc,Ct",  MATCH_C_MUL, MASK_C_MUL, match_opcode, 0 },
...
{"sext.b",     0, INSN_CLASS_ZCEE, "CZc,Cw", MATCH_C_SEXT_B, MASK_C_SEXT_B, match_opcode, INSN_ALIAS },
...
{"sext.h",     0, INSN_CLASS_ZCEE, "CZc,Cw", MATCH_C_SEXT_H, MASK_C_SEXT_H, match_opcode, INSN_ALIAS },
...
{"zext.h",     0, INSN_CLASS_ZCEE, "CZc,Cw", MATCH_C_ZEXT_H, MASK_C_ZEXT_H, match_opcode, INSN_ALIAS },
...
{"zext.w",    64, INSN_CLASS_ZCEE, "CZc,Cw", MATCH_C_ZEXT_W, MASK_C_ZEXT_W, match_opcode, INSN_ALIAS },
...
{"cv.exths",   0, INSN_CLASS_COREV_ALU, "d,s",      MATCH_CV_EXTHS,   MASK_CV_ABS,  match_opcode, 0},
{"cv.exthz",   0, INSN_CLASS_COREV_ALU, "d,s",      MATCH_CV_EXTHZ,   MASK_CV_ABS,  match_opcode, 0},
{"cv.extbs",   0, INSN_CLASS_COREV_ALU, "d,s",      MATCH_CV_EXTBS,   MASK_CV_ABS,  match_opcode, 0},
{"cv.extbz",   0, INSN_CLASS_COREV_ALU, "d,s",      MATCH_CV_EXTBZ,   MASK_CV_ABS,  match_opcode, 0},
...
{"cv.lb", 0, INSN_CLASS_COREV_MEM, "d,o(s)",  MATCH_LB,           MASK_LB,          match_opcode, INSN_DREF|INSN_1_BYTE},
{"cv.lb", 0, INSN_CLASS_COREV_MEM, "d,o(s!)", MATCH_CV_LBPOST,    MASK_CV_LPOST,    match_opcode, 0},
{"cv.lb", 0, INSN_CLASS_COREV_MEM, "d,t(s!)", MATCH_CV_LBRRPOST,  MASK_CV_LRRPOST,  match_opcode, 0},
{"cv.lb", 0, INSN_CLASS_COREV_MEM, "d,t(s)",  MATCH_CV_LBRR,      MASK_CV_LRR,      match_opcode, 0},
{"cv.lbu",0, INSN_CLASS_COREV_MEM, "d,o(s)",  MATCH_LBU,          MASK_LBU,         match_opcode, INSN_DREF|INSN_1_BYTE},
{"cv.lbu",0, INSN_CLASS_COREV_MEM, "d,o(s!)", MATCH_CV_LBUPOST,   MASK_CV_LPOST,    match_opcode, 0},
{"cv.lbu",0, INSN_CLASS_COREV_MEM, "d,t(s!)", MATCH_CV_LBURRPOST, MASK_CV_LRRPOST,  match_opcode, 0},
{"cv.lbu",0, INSN_CLASS_COREV_MEM, "d,t(s)",  MATCH_CV_LBURR,     MASK_CV_LRR,      match_opcode, 0},
{"cv.lh", 0, INSN_CLASS_COREV_MEM, "d,o(s)",  MATCH_LH,           MASK_LH,          match_opcode, INSN_DREF|INSN_2_BYTE},
{"cv.lh", 0, INSN_CLASS_COREV_MEM, "d,o(s!)", MATCH_CV_LHPOST,    MASK_CV_LPOST,    match_opcode, 0},
{"cv.lh", 0, INSN_CLASS_COREV_MEM, "d,t(s!)", MATCH_CV_LHRRPOST,  MASK_CV_LRRPOST,  match_opcode, 0},
{"cv.lh", 0, INSN_CLASS_COREV_MEM, "d,t(s)",  MATCH_CV_LHRR,      MASK_CV_LRR,      match_opcode, 0},
{"cv.lhu",0, INSN_CLASS_COREV_MEM, "d,o(s)",  MATCH_LHU,          MASK_LHU,         match_opcode, INSN_DREF|INSN_2_BYTE},
{"cv.lhu",0, INSN_CLASS_COREV_MEM, "d,o(s!)", MATCH_CV_LHUPOST,   MASK_CV_LPOST,    match_opcode, 0},
{"cv.lhu",0, INSN_CLASS_COREV_MEM, "d,t(s!)", MATCH_CV_LHURRPOST, MASK_CV_LRRPOST,  match_opcode, 0},
{"cv.lhu",0, INSN_CLASS_COREV_MEM, "d,t(s)",  MATCH_CV_LHURR,     MASK_CV_LRR,      match_opcode, 0},
{"cv.lw", 0, INSN_CLASS_COREV_MEM, "d,o(s)",  MATCH_LW,           MASK_LW,          match_opcode, INSN_DREF|INSN_4_BYTE},
{"cv.lw", 0, INSN_CLASS_COREV_MEM, "d,o(s!)", MATCH_CV_LWPOST,    MASK_CV_LPOST,    match_opcode, 0},
{"cv.lw", 0, INSN_CLASS_COREV_MEM, "d,t(s!)", MATCH_CV_LWRRPOST,  MASK_CV_LRRPOST,  match_opcode, 0},
{"cv.lw", 0, INSN_CLASS_COREV_MEM, "d,t(s)",  MATCH_CV_LWRR,      MASK_CV_LRR,      match_opcode, 0},
{"cv.sb", 0, INSN_CLASS_COREV_MEM, "t,q(s)",  MATCH_SB,           MASK_SB,          match_opcode, INSN_DREF|INSN_1_BYTE},
{"cv.sb", 0, INSN_CLASS_COREV_MEM, "t,q(s!)", MATCH_CV_SBPOST,    MASK_CV_SPOST,    match_opcode, 0},
{"cv.sb", 0, INSN_CLASS_COREV_MEM, "t,d(s)",  MATCH_CV_SBRR,      MASK_CV_SRR,      match_opcode, 0},
{"cv.sb", 0, INSN_CLASS_COREV_MEM, "t,d(s!)", MATCH_CV_SBRRPOST,  MASK_CV_SRRPOST,  match_opcode, 0},
{"cv.sh", 0, INSN_CLASS_COREV_MEM, "t,q(s)",  MATCH_SH,           MASK_SH,          match_opcode, INSN_DREF|INSN_2_BYTE},
{"cv.sh", 0, INSN_CLASS_COREV_MEM, "t,q(s!)", MATCH_CV_SHPOST,    MASK_CV_SPOST,    match_opcode, 0},
{"cv.sh", 0, INSN_CLASS_COREV_MEM, "t,d(s)",  MATCH_CV_SHRR,      MASK_CV_SRR,      match_opcode, 0},
{"cv.sh", 0, INSN_CLASS_COREV_MEM, "t,d(s!)", MATCH_CV_SHRRPOST,  MASK_CV_SRRPOST,  match_opcode, 0},
{"cv.sw", 0, INSN_CLASS_COREV_MEM, "t,q(s)",  MATCH_SW,           MASK_SW,          match_opcode, INSN_DREF|INSN_4_BYTE},
{"cv.sw", 0, INSN_CLASS_COREV_MEM, "t,q(s!)", MATCH_CV_SWPOST,    MASK_CV_SPOST,    match_opcode, 0},
